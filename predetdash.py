...
num_stocks = st.slider('How many stocks are in your portfolio?: ',1,8,1)
invested_amount = st.number_input('What is your principal amount invested?')

tickers = []

st.header('Ticker of Stocks')
tics = ['AAPL','FB','GE','GME','MMM','MSFT','PTC','T']
st.write(tics)
...
AAPL = pd.read_csv('../AlgoTrade/Stock_data/AAPL.csv')  
FB = pd.read_csv('../AlgoTrade/Stock_data/FB.csv')  
GE = pd.read_csv('../AlgoTrade/Stock_data/GE.csv')  
GME = pd.read_csv('../AlgoTrade/Stock_data/GME.csv')  
MMM = pd.read_csv('../AlgoTrade/Stock_data/MMM.csv')  
MSFT = pd.read_csv('../AlgoTrade/Stock_data/MSFT.csv')  
PTC = pd.read_csv('../AlgoTrade/Stock_data/PTC.csv')  
T = pd.read_csv('../AlgoTrade/Stock_data/T.csv')  

ticker = AAPL
tic_data = ticker
st.write(tic_data)
tic_data = tic_data[['Date','Close/Last']]
st.write(tic_data)
